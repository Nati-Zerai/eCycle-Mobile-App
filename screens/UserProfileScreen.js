...
const UserProfileScreen = () => {
  ...
  return (
    <ScrollView>
        ...
        {/* Details Area */}
        <Text className="text-xl font-semibold self-center mt-2">Personal Details</Text>
      <View className="rounded-xl m-4 pb-1 bg-white">
        <View className="w-96 pb-4 px-4 self-center flex">
        </View>
        <View className="pt-2 px-4">
            <Text className="">First Name</Text>
            <TextInput className="w-full h-10 border-b-2 border-black-400"/>
        </View>
        <View className="pt-2 px-4">
        ...
        <View className="self-center mx-4 mt-4 mb-4 px-8 py-3 rounded-xl bg-[#7cc464]">
            <TouchableOpacity>
