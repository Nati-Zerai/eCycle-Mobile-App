    ...
    <View>
      ...
      <View className="h-[100%] items-center justify-center relative">
        <View className="flex items-center -translate-y-40 p-4">
            ...
            <Text className="text-black-500 font-bold text-xl mt-4">No Cards found</Text>
            <Text className="text-gray-500">Your registered cards will appear here</Text>
        </View>
        <TouchableOpacity>
                <Text className="px-16 py-4 border-2 rounded-3xl">Add new card</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
