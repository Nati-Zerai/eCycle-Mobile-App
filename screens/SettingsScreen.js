...
import { ChevronRightIcon, Cog6ToothIcon, CreditCardIcon, MapPinIcon, TrophyIcon, UserIcon } from 'react-native-heroicons/outline'
...
const SettingsScreen = () => {
  ...
  return (
    <View>
      ...
      <View>
        <TouchableOpacity className="flex-row border-b items-center border-slate-400 p-4"
        onPress={() => navigation.navigate("UserProfile")}>
            <UserIcon size={30} color="#000000"/>
            <View className="px-4 flex-1">
            <Text className="font-medium text-base">Personal details</Text>
            <Text className="text-slate-500">First name, last name, email address</Text>
            </View>
        ...
        onPress={() => navigation.navigate("DeliveryAddress")}>
            ...
            <Text className="text-slate-500">Add, edit and delete addresses</Text>
            </View>
            <ChevronRightIcon size={20} color="#000000"/>
        </TouchableOpacity>
        <TouchableOpacity className="flex-row border-b items-center border-slate-400 p-4"
        onPress={() => navigation.navigate("DeliveryAddress")}>
            ...
            <View className="px-4 flex-1">
            <Text className="font-medium text-base">My eCyclePoints</Text>
            <Text className="text-slate-500">Manage your eCyclePoints</Text>
            </View>
            <ChevronRightIcon size={20} color="#000000"/>
        </TouchableOpacity>
        <TouchableOpacity className="flex-row border-b items-center border-slate-400 p-4"
